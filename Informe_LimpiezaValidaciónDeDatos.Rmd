...
Como uno de los propósitos es realizar una recomendación hacia la nueva industria sobre qué características debe tener un juego para ser exitoso, vamos a realizar una comparativa entre las siguientes variables:
...
```{r,eval=TRUE,echo=TRUE}
write.csv2(videogamesnewS , file="vgsales_clean.csv", row.names = FALSE)
```
